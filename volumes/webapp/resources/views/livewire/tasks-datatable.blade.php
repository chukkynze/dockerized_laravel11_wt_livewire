                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3" wire:click="setSortBy('priority')">priority</th>
                        ...
                        @foreach($projects as $project)
                            <tr wire:key="{{ $project->getUuid() }}" class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 text-green-500">{{$project->getPriority()}}</td>
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button class="px-3 py-1 bg-blue-500 text-white rounded">X</button>
                                    <button onclick="confirm('Are you sure you want to mark the {{ $project->getName() }} as deleted?') || event.stopImmediatePropagation() " wire:click="delete('{{$project->getUuid()}}')" class="px-3 py-1 bg-red-500 text-white rounded">X</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
